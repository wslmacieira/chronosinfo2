      ...
      (!(function (e) {
        ...
        function n(e) {
          var t = "length" in e && e.length,
            n = ie.type(e);
          return "function" === n || ie.isWindow(e)
            ? !1
            : 1 === e.nodeType && t
            ? !0
            : "array" === n ||
        ...
        function b(e) {
          return (
            (e.type = (null !== ie.find.attr(e, "type")) + "/" + e.type), e
          );
        }
        function x(e) {
        ...
        var ue = (function (e) {
          ...
          function y(e) {
            for (
              ...
              if ((n = T.relative[e[s].type])) c = [p(h(c), n)];
                ...
                if (
                  ((n = T.filter[e[s].type].apply(null, e[s].matches)), n[R])
                ) {
          ...
          try {
            K.apply((J = Z.call(P.childNodes)), P.childNodes),
          ...
          (w = t.support = {}),
                        ...
                        return n
                          ...
                          : ((n =
                            ...
                            (!w.sortDetached &&
                              ...
                              ? e === r || (e.ownerDocument === P && B(P, e))
                                ? -1
                                : t === r || (t.ownerDocument === P && B(P, t))
                                ? 1
                                : j
                                ? ee(j, e) - ee(j, t)
                                : 0
            ...
            (t.attr = function (e, t) {
              ...
              var n = T.attrHandle[t.toLowerCase()],
                r =
                  n && Q.call(T.attrHandle, t.toLowerCase())
                    ? n(e, t, !q)
                    : void 0;
              return void 0 !== r
                ? r
            ...
            (S = t.select = function (e, t, n, r) {
              ...
              if (((n = n || []), 1 === d.length)) {
                if (
                  ...
                  if (
                    ((t = (T.find.ID(a.matches[0].replace(we, Te), t) ||
                      [])[0]),
                    !t)
                  )
                    return n;
        ...
        (ie.Callbacks = function (e) {
          ...
          var t,
            ...
            c = function (o) {
              ...
              (t = !1),
                l &&
                  (u ? u.length && c(u.shift()) : n ? (l = []) : d.disable());
            },
            d = {
              add: function () {
                if (l) {
        ...
        (ie.event = {
          ...
          (ie.removeEvent = he.removeEventListener
            ...
            : function (e, t, n) {
                var r = "on" + t;
                e.detachEvent &&
                  (typeof e[r] === Ne && (e[r] = null), e.detachEvent(r, n));
              }),
          ...
          ne.changeBubbles ||
            (ie.event.special.change = {
              setup: function () {
                return Le.test(this.nodeName)
                  ? (("checkbox" === this.type || "radio" === this.type) &&
                      (ie.event.add(this, "propertychange._change", function (
                        e
                      ) {
                    ...
                    !1)
                  : void ie.event.add(this, "beforeactivate._change", function (
                      e
                    ) {
                      var t = e.target;
                      Le.test(t.nodeName) &&
              ...
              teardown: function () {
                return (
                  ie.event.remove(this, "._change"), !Le.test(this.nodeName)
                );
              },
            }),
          ne.focusinBubbles ||
              ...
              return e && 3 !== o && 8 !== o && 2 !== o
                ? typeof e.getAttribute === Ne
                  ...
                  : ((1 === o && ie.isXMLDoc(e)) ||
                      ...
                      (r =
                        ie.attrHooks[t] ||
                        (ie.expr.match.bool.test(t) ? Tt : wt))),
                    void 0 === n
        ...
        ie.fn.extend({
          ...
          hasClass: function (e) {
            for (var t = " " + e + " ", n = 0, r = this.length; r > n; n++)
              if (
                1 === this[n].nodeType &&
                (" " + this[n].className + " ").replace(jt, " ").indexOf(t) >= 0
              )
                return !0;
            return !1;
          },
          ...
          ie.fn.extend({
            offset: function (e) {
              ...
              return o
                ? ((t = o.documentElement),
                  ie.contains(t, i)
                    ? (typeof i.getBoundingClientRect !== Ne &&
  ...
  (N2Deferred.n2When = function (e) {
    ...
    if (0 === t) n.resolve();
      ...
      for (
        ...
        e[o] instanceof N2Deferred ? e[o].then(i) : i();
    return n;
  }),
  function (e) {
    "use strict";
    this.N2Classes = {};
    var t = {};
    this.N2D = function (n, r, i) {
      var o = [];
      if (
        (n && t[n] === e && (t[n] = new N2Deferred()),
        2 === arguments.length
          ? ((i = arguments[1]), (r = []))
          : "string" == typeof r && (r = [r]),
        (r = r || []),
        ...
        for (var a = 0; a < r.length; a++)
          t[r[a]] === e && (t[r[a]] = new N2Deferred()), o.push(t[r[a]]);
      N2Deferred.n2When(o).then(function () {
        if ("function" == typeof i) {
          var e = i.apply(N2Classes, [N2Classes.$]);
          e instanceof N2Deferred
            ? e.then(function (e) {
    ...
    for (var n = 0; n < this.N2_.d.length; n++)
      this.N2D.apply(this, this.N2_.d[n]);
    this.N2R = function (n, r) {
      ...
      if (
        ...
        for (var o = 0; o < n.length; o++)
          t[n[o]] === e && (t[n[o]] = new N2Deferred()), i.push(t[n[o]]);
      N2Deferred.n2When(i).then(function () {
        for (var e = [N2Classes.$], t = 0; t < n.length - 1; t++)
          e.push(N2Classes[n[t]]);
        r.apply(N2Classes, e);
      });
    };
    for (var r = 0; r < this.N2_.r.length; r++)
      this.N2R.apply(this, this.N2_.r[r]);
  }.call(window),
  (function () {
    var e = new Date(),
      t = function () {
        if (window.nextend && window.jQuery) {
          ...
          (setTimeout(t, 20), new Date().getTime() - e.getTime() > 1e3)
        ) {
